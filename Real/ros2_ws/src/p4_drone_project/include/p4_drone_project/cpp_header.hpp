...
{   
    public:
        ...
        {
            viconPubliser_ = this->create_publisher<std_msgs::msg::Float64MultiArray>("vicon_topic", 10);
            ...
            while (clientIsConnected.Connected)
            {
                ...
                // if connection get info about drone and publish it to the "vicon_topic" topic
