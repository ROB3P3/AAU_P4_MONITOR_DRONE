...
pathToViconCSV = "/home/drone/Documents/GitHub/AAU_P4_MONITOR_DRONE-1/Real/DATA/Gode tests/Vicon Test " + str(testNumber) + ".csv"
pathToPathPlannerCSV = "/home/drone/Documents/GitHub/AAU_P4_MONITOR_DRONE-1/Real/DATA/Gode tests/PathData test " + str(testNumber) + ".csv"

os.makedirs("/home/drone/Documents/GitHub/AAU_P4_MONITOR_DRONE-1/Real/DATA/Gode tests/Test figures/Test " + str(testNumber), exist_ok=True)
os.chdir("/home/drone/Documents/GitHub/AAU_P4_MONITOR_DRONE-1/Real/DATA/Gode tests/Test figures/Test " + str(testNumber))
