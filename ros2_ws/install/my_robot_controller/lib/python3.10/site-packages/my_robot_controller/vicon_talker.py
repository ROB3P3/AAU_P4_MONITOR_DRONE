...
class ViconTalker(Node):
    def __init__(self):
        ...
        self.cmd_publisher_ = self.create_publisher(Float64MultiArray, "/pid_comparison_vicon", 10)
    ...
    def broadcast(self):
        ...
        TEMP_INPUT = [random.uniform(0.0, 300.0), random.uniform(0.0, 300.0), random.uniform(98.0, 102.0), random.uniform(0.0, 90.0)]
