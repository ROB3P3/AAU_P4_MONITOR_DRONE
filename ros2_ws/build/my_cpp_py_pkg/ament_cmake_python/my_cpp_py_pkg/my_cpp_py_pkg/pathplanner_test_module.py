...
class PathPlannerTalker(Node):
    def __init__(self):
        ...
        self.cmd_publisher_ = self.create_publisher(PathPlannerPoints, "/pid_regulator_pathplanner", 10)
    ...
    def broadcast(self):
        ...
        self.get_logger().info("Attempt to send PathPlanner points to Regulator node.")
