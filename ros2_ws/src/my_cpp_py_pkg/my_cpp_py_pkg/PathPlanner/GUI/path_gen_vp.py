...
def path_generator():
    ...
    # Load the image
    background = pygame.image.load(f'/home/frederik/Documents/P4/P4Git/AAU_P4_MONITOR_DRONE/ros2_ws/src/my_cpp_py_pkg/my_cpp_py_pkg/PathPlanner/GUI/Mark_billeder/Mark{random_number}.png')
