...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "vicon_talker = my_robot_controller.vicon_talker:main",
            "pathplanner_talker = my_robot_controller.pathplanner_talker:main",
            "compare_listener = my_robot_controller.compare_listener:main"
        ],
    },
)
